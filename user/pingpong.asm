...
int pingpong(void){
  ...
  12:	338080e7          	jalr	824(ra) # 346 <pipe>
    int p2[2];
    pipe(p2);
  16:	fd040513          	addi	a0,s0,-48
  1a:	00000097          	auipc	ra,0x0
  1e:	32c080e7          	jalr	812(ra) # 346 <pipe>
    char buffer;
    if(fork() == 0){
  22:	00000097          	auipc	ra,0x0
  26:	30c080e7          	jalr	780(ra) # 32e <fork>
  2a:	e531                	bnez	a0,76 <pingpong+0x76>
        int pid = getpid();
  2c:	00000097          	auipc	ra,0x0
  30:	38a080e7          	jalr	906(ra) # 3b6 <getpid>
  34:	84aa                	mv	s1,a0
        read(p1[0], &buffer , 1);
  36:	4605                	li	a2,1
  ...
  44:	30e080e7          	jalr	782(ra) # 34e <read>
        printf("%d: received ping\n" , pid);
  48:	85a6                	mv	a1,s1
  4a:	00001517          	auipc	a0,0x1
  4e:	80650513          	addi	a0,a0,-2042 # 850 <malloc+0xe4>
  52:	00000097          	auipc	ra,0x0
  56:	65c080e7          	jalr	1628(ra) # 6ae <printf>
        write(p2[1], &buffer , 1);
  5a:	4605                	li	a2,1
  5c:	fcf40593          	addi	a1,s0,-49
  60:	fd442503          	lw	a0,-44(s0)
  64:	00000097          	auipc	ra,0x0
  68:	2f2080e7          	jalr	754(ra) # 356 <write>
        exit(0);
  6c:	4501                	li	a0,0
  ...
  7a:	340080e7          	jalr	832(ra) # 3b6 <getpid>
  7e:	84aa                	mv	s1,a0
        write(p1[1],&buffer,1);
  80:	4605                	li	a2,1
  ...
  8e:	2cc080e7          	jalr	716(ra) # 356 <write>
        read(p2[0],&buffer, 1);
  92:	4605                	li	a2,1
  94:	fcf40593          	addi	a1,s0,-49
  98:	fd042503          	lw	a0,-48(s0)
  9c:	00000097          	auipc	ra,0x0
  a0:	2b2080e7          	jalr	690(ra) # 34e <read>
        printf("%d: received pong\n",pid);
  a4:	85a6                	mv	a1,s1
  a6:	00000517          	auipc	a0,0x0
  aa:	7c250513          	addi	a0,a0,1986 # 868 <malloc+0xfc>
  ae:	00000097          	auipc	ra,0x0
  b2:	600080e7          	jalr	1536(ra) # 6ae <printf>
        exit(0);
  b6:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41e:	46e50513          	addi	a0,a0,1134 # 888 <digits>
 422:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 62a:	25a90913          	addi	s2,s2,602 # 880 <malloc+0x114>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f2:	1b27b783          	ld	a5,434(a5) # 8a0 <freep>
...
malloc(uint nbytes)
{
 ...
 794:	11053503          	ld	a0,272(a0) # 8a0 <freep>
 ...
 7bc:	0e890913          	addi	s2,s2,232 # 8a0 <freep>
  if(p == (char*)-1)
 7c0:	5afd                	li	s5,-1
 7c2:	a88d                	j	834 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7c4:	00000797          	auipc	a5,0x0
 7c8:	0e478793          	addi	a5,a5,228 # 8a8 <base>
 7cc:	00000717          	auipc	a4,0x0
 7d0:	0cf73a23          	sd	a5,212(a4) # 8a0 <freep>
 7d4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f6:	0aa73723          	sd	a0,174(a4) # 8a0 <freep>
      return (void*)(p + 1);
