...
int onceprimes(int* array , int n  ){ 
  ...
  2a:	714080e7          	jalr	1812(ra) # 73a <printf>
    int p[2];
    pipe(p);   
  2e:	fb840513          	addi	a0,s0,-72
  32:	00000097          	auipc	ra,0x0
  36:	3a0080e7          	jalr	928(ra) # 3d2 <pipe>
    int np[2]  ;
    pipe (np);
  3a:	fb040513          	addi	a0,s0,-80
  3e:	00000097          	auipc	ra,0x0
  42:	394080e7          	jalr	916(ra) # 3d2 <pipe>
    if(fork() == 0){
  46:	00000097          	auipc	ra,0x0
  4a:	374080e7          	jalr	884(ra) # 3ba <fork>
  4e:	e911                	bnez	a0,62 <onceprimes+0x62>
  50:	892a                	mv	s2,a0
        int buf;
        int counter = 0;
        for(int i = 0; i < n ; i++){
  52:	09305963          	blez	s3,e4 <onceprimes+0xe4>
  56:	84aa                	mv	s1,a0
            read(p[0] , &buf , 4);
            if(buf % a != 0){
                array[counter] = buf;
  ...
  58:	00001b17          	auipc	s6,0x1
  5c:	898b0b13          	addi	s6,s6,-1896 # 8f0 <malloc+0xf8>
  60:	a09d                	j	c6 <onceprimes+0xc6>
        ...
        int c;
        for(int i = 0 ; i < n ; i++){                        
  62:	03305a63          	blez	s3,96 <onceprimes+0x96>
  66:	8952                	mv	s2,s4
  68:	fff9849b          	addiw	s1,s3,-1
  6c:	1482                	slli	s1,s1,0x20
  6e:	9081                	srli	s1,s1,0x20
  70:	048a                	slli	s1,s1,0x2
  72:	0a11                	addi	s4,s4,4
  74:	94d2                	add	s1,s1,s4
            buf = array[i] ;
  76:	00092783          	lw	a5,0(s2)
  7a:	faf42623          	sw	a5,-84(s0)
            write(p[1], &buf ,4);
  7e:	4611                	li	a2,4
  80:	fac40593          	addi	a1,s0,-84
  84:	fbc42503          	lw	a0,-68(s0)
  88:	00000097          	auipc	ra,0x0
  8c:	35a080e7          	jalr	858(ra) # 3e2 <write>
        for(int i = 0 ; i < n ; i++){                        
  90:	0911                	addi	s2,s2,4
  92:	fe9912e3          	bne	s2,s1,76 <onceprimes+0x76>
  ...
  9c:	332080e7          	jalr	818(ra) # 3ca <wait>
        exit(0);
  a0:	4501                	li	a0,0
  a2:	00000097          	auipc	ra,0x0
  a6:	320080e7          	jalr	800(ra) # 3c2 <exit>
                array[counter] = buf;
  aa:	00291713          	slli	a4,s2,0x2
  ae:	9752                	add	a4,a4,s4
  b0:	c31c                	sw	a5,0(a4)
                counter ++;
  ...
  bc:	682080e7          	jalr	1666(ra) # 73a <printf>
        for(int i = 0; i < n ; i++){
  c0:	2485                	addiw	s1,s1,1
  c2:	02998163          	beq	s3,s1,e4 <onceprimes+0xe4>
            read(p[0] , &buf , 4);
  c6:	4611                	li	a2,4
  c8:	fac40593          	addi	a1,s0,-84
  cc:	fb842503          	lw	a0,-72(s0)
  d0:	00000097          	auipc	ra,0x0
  d4:	30a080e7          	jalr	778(ra) # 3da <read>
            if(buf % a != 0){
  d8:	fac42783          	lw	a5,-84(s0)
  dc:	0357e73b          	remw	a4,a5,s5
  e0:	d365                	beqz	a4,c0 <onceprimes+0xc0>
  e2:	b7e1                	j	aa <onceprimes+0xaa>
        close(p[0]);
  e4:	fb842503          	lw	a0,-72(s0)
  e8:	00000097          	auipc	ra,0x0
  ec:	302080e7          	jalr	770(ra) # 3ea <close>
        close(p[1]); 
  f0:	fbc42503          	lw	a0,-68(s0)
  f4:	00000097          	auipc	ra,0x0
  f8:	2f6080e7          	jalr	758(ra) # 3ea <close>
        read(np[0], &c , 4);
  ...
  fc:	854a                	mv	a0,s2
  fe:	60e6                	ld	ra,88(sp)
 100:	6446                	ld	s0,80(sp)
 102:	64a6                	ld	s1,72(sp)
 104:	6906                	ld	s2,64(sp)
 106:	79e2                	ld	s3,56(sp)
 108:	7a42                	ld	s4,48(sp)
 10a:	7aa2                	ld	s5,40(sp)
 10c:	7b02                	ld	s6,32(sp)
 10e:	6125                	addi	sp,sp,96
 110:	8082                	ret
...
int main(void){
 112:	7175                	addi	sp,sp,-144
 114:	e506                	sd	ra,136(sp)
 116:	e122                	sd	s0,128(sp)
 118:	0900                	addi	s0,sp,144
 /*   printf("for test1\n");   */

    int rn = 30;
    int array[32];
    for(int i = 0; i < rn ; i++){
 11a:	f7040793          	addi	a5,s0,-144
 11e:	fe840693          	addi	a3,s0,-24
int main(void){
 122:	4709                	li	a4,2
        array[i] = i+2 ;    
 124:	c398                	sw	a4,0(a5)
    for(int i = 0; i < rn ; i++){
 126:	2705                	addiw	a4,a4,1
 128:	0791                	addi	a5,a5,4
 ...
 130:	f7040513          	addi	a0,s0,-144
 134:	00000097          	auipc	ra,0x0
 138:	ecc080e7          	jalr	-308(ra) # 0 <onceprimes>
 13c:	85aa                	mv	a1,a0
    while(rn >= 1){
 13e:	fea049e3          	bgtz	a0,130 <main+0x1e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	47250513          	addi	a0,a0,1138 # 918 <digits>
 4ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 576:	3a6b8b93          	addi	s7,s7,934 # 918 <digits>
 ...
 6b6:	25e90913          	addi	s2,s2,606 # 910 <malloc+0x118>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77e:	1b67b783          	ld	a5,438(a5) # 930 <freep>
 ...
 7ac:	00e6ea63          	bltu	a3,a4,7c0 <free+0x50>
{
 ...
 7ee:	14f73323          	sd	a5,326(a4) # 930 <freep>
}
 7f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 820:	11453503          	ld	a0,276(a0) # 930 <freep>
 ...
 848:	0ec90913          	addi	s2,s2,236 # 930 <freep>
  if(p == (char*)-1)
 84c:	5afd                	li	s5,-1
 84e:	a88d                	j	8c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 850:	00000797          	auipc	a5,0x0
 854:	0e878793          	addi	a5,a5,232 # 938 <base>
 858:	00000717          	auipc	a4,0x0
 85c:	0cf73c23          	sd	a5,216(a4) # 930 <freep>
 860:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
