...
void primes(void){
  ...
  14:	336080e7          	jalr	822(ra) # 346 <pipe>
    if(fork() == 0){
  18:	00000097          	auipc	ra,0x0
  1c:	316080e7          	jalr	790(ra) # 32e <fork>
  20:	ed31                	bnez	a0,7c <primes+0x7c>
        int buf;
        close(0);
  22:	00000097          	auipc	ra,0x0
  26:	33c080e7          	jalr	828(ra) # 35e <close>
        dup(p[0]);
  2a:	fd842503          	lw	a0,-40(s0)
  2e:	00000097          	auipc	ra,0x0
  32:	380080e7          	jalr	896(ra) # 3ae <dup>
        close(p[0]); 
  36:	fd842503          	lw	a0,-40(s0)
  3a:	00000097          	auipc	ra,0x0
  3e:	324080e7          	jalr	804(ra) # 35e <close>
  42:	02200493          	li	s1,34
        for(int i = 2; i <= 35; i++){
        read(0, &buf , 4);  
        printf("the number is %d\n",buf); 
  46:	00001917          	auipc	s2,0x1
  4a:	80a90913          	addi	s2,s2,-2038 # 850 <malloc+0xe4>
        read(0, &buf , 4);  
  4e:	4611                	li	a2,4
  50:	fd440593          	addi	a1,s0,-44
  54:	4501                	li	a0,0
  56:	00000097          	auipc	ra,0x0
  5a:	2f8080e7          	jalr	760(ra) # 34e <read>
        printf("the number is %d\n",buf); 
  5e:	fd442583          	lw	a1,-44(s0)
  62:	854a                	mv	a0,s2
  64:	00000097          	auipc	ra,0x0
  68:	64a080e7          	jalr	1610(ra) # 6ae <printf>
        for(int i = 2; i <= 35; i++){
  6c:	34fd                	addiw	s1,s1,-1
  6e:	f0e5                	bnez	s1,4e <primes+0x4e>
            int data = i;
        write(1, &data , 4);
  ...
  82:	2e0080e7          	jalr	736(ra) # 35e <close>
        dup(p[1]);
  86:	fdc42503          	lw	a0,-36(s0)
  8a:	00000097          	auipc	ra,0x0
  8e:	324080e7          	jalr	804(ra) # 3ae <dup>
        close(p[1]);
  92:	fdc42503          	lw	a0,-36(s0)
  96:	00000097          	auipc	ra,0x0
  9a:	2c8080e7          	jalr	712(ra) # 35e <close>
        for (int i = 2 ; i <= 35 ; i ++){
  9e:	4489                	li	s1,2
  a0:	02400913          	li	s2,36
            int data = i;
  a4:	fc942a23          	sw	s1,-44(s0)
        write(1, &data , 4);
  a8:	4611                	li	a2,4
  aa:	fd440593          	addi	a1,s0,-44
  ae:	4505                	li	a0,1
  b0:	00000097          	auipc	ra,0x0
  b4:	2a6080e7          	jalr	678(ra) # 356 <write>
        for (int i = 2 ; i <= 35 ; i ++){
  b8:	2485                	addiw	s1,s1,1
  ba:	ff2495e3          	bne	s1,s2,a4 <primes+0xa4>
  be:	bf4d                	j	70 <primes+0x70>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41e:	45650513          	addi	a0,a0,1110 # 870 <digits>
 422:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ea:	38ab8b93          	addi	s7,s7,906 # 870 <digits>
 ...
 62a:	24290913          	addi	s2,s2,578 # 868 <malloc+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f2:	19a7b783          	ld	a5,410(a5) # 888 <freep>
 ...
 720:	00e6ea63          	bltu	a3,a4,734 <free+0x50>
{
 ...
 762:	12f73523          	sd	a5,298(a4) # 888 <freep>
}
 766:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 794:	0f853503          	ld	a0,248(a0) # 888 <freep>
 ...
 7bc:	0d090913          	addi	s2,s2,208 # 888 <freep>
  if(p == (char*)-1)
 7c0:	5afd                	li	s5,-1
 7c2:	a88d                	j	834 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7c4:	00000797          	auipc	a5,0x0
 7c8:	0cc78793          	addi	a5,a5,204 # 890 <base>
 7cc:	00000717          	auipc	a4,0x0
 7d0:	0af73e23          	sd	a5,188(a4) # 888 <freep>
 7d4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f6:	08a73b23          	sd	a0,150(a4) # 888 <freep>
      return (void*)(p + 1);
