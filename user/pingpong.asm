...
int main(void){
  ...
  12:	342080e7          	jalr	834(ra) # 350 <pipe>
    int p2[2];
    pipe(p2);
  16:	fd040513          	addi	a0,s0,-48
  1a:	00000097          	auipc	ra,0x0
  1e:	336080e7          	jalr	822(ra) # 350 <pipe>
    char buffer;
    if(fork() == 0){
  22:	00000097          	auipc	ra,0x0
  26:	316080e7          	jalr	790(ra) # 338 <fork>
  2a:	e531                	bnez	a0,76 <main+0x76>
        int pid = getpid();
  2c:	00000097          	auipc	ra,0x0
  30:	394080e7          	jalr	916(ra) # 3c0 <getpid>
  34:	84aa                	mv	s1,a0
        read(p1[0], &buffer , 1);
  36:	4605                	li	a2,1
  38:	fcf40593          	addi	a1,s0,-49
  3c:	fd842503          	lw	a0,-40(s0)
  40:	00000097          	auipc	ra,0x0
  44:	318080e7          	jalr	792(ra) # 358 <read>
        printf("%d: received ping\n" , pid);
  48:	85a6                	mv	a1,s1
  4a:	00001517          	auipc	a0,0x1
  4e:	81650513          	addi	a0,a0,-2026 # 860 <malloc+0xea>
  52:	00000097          	auipc	ra,0x0
  56:	666080e7          	jalr	1638(ra) # 6b8 <printf>
        write(p2[1], &buffer , 1);
  5a:	4605                	li	a2,1
  5c:	fcf40593          	addi	a1,s0,-49
  ...
  72:	2d2080e7          	jalr	722(ra) # 340 <exit>
    }
    else{
        int pid = getpid();
  76:	00000097          	auipc	ra,0x0
  7a:	34a080e7          	jalr	842(ra) # 3c0 <getpid>
  7e:	84aa                	mv	s1,a0
        write(p1[1],&buffer,1);
  80:	4605                	li	a2,1
  82:	fcf40593          	addi	a1,s0,-49
  86:	fdc42503          	lw	a0,-36(s0)
  8a:	00000097          	auipc	ra,0x0
  8e:	2d6080e7          	jalr	726(ra) # 360 <write>
        read(p2[0],&buffer, 1);
  92:	4605                	li	a2,1
  94:	fcf40593          	addi	a1,s0,-49
  98:	fd042503          	lw	a0,-48(s0)
  9c:	00000097          	auipc	ra,0x0
  a0:	2bc080e7          	jalr	700(ra) # 358 <read>
        printf("%d: received pong\n",pid);
  a4:	85a6                	mv	a1,s1
  a6:	00000517          	auipc	a0,0x0
  aa:	7d250513          	addi	a0,a0,2002 # 878 <malloc+0x102>
  ae:	00000097          	auipc	ra,0x0
  b2:	60a080e7          	jalr	1546(ra) # 6b8 <printf>
        wait(0);
  b6:	4501                	li	a0,0
  b8:	00000097          	auipc	ra,0x0
  bc:	290080e7          	jalr	656(ra) # 348 <wait>
        exit(0);
  c0:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 428:	47450513          	addi	a0,a0,1140 # 898 <digits>
 42c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f4:	3a8b8b93          	addi	s7,s7,936 # 898 <digits>
 ...
 634:	26090913          	addi	s2,s2,608 # 890 <malloc+0x11a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6fc:	1b87b783          	ld	a5,440(a5) # 8b0 <freep>
...
malloc(uint nbytes)
{
 ...
 79e:	11653503          	ld	a0,278(a0) # 8b0 <freep>
 ...
 7c6:	0ee90913          	addi	s2,s2,238 # 8b0 <freep>
  if(p == (char*)-1)
 7ca:	5afd                	li	s5,-1
 7cc:	a88d                	j	83e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ce:	00000797          	auipc	a5,0x0
 7d2:	0ea78793          	addi	a5,a5,234 # 8b8 <base>
 7d6:	00000717          	auipc	a4,0x0
 7da:	0cf73d23          	sd	a5,218(a4) # 8b0 <freep>
 7de:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
