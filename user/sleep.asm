...
main(int argc, char *argv[])
{
  ...
  12:	1ac080e7          	jalr	428(ra) # 1ba <atoi>
  if(argc == 1){
  16:	4785                	li	a5,1
  18:	00f48b63          	beq	s1,a5,2e <main+0x2e>
    write(1 , "error" , 6);
  }
  else{
    sleep(n);
  1c:	00000097          	auipc	ra,0x0
  20:	32e080e7          	jalr	814(ra) # 34a <sleep>
  }
  exit(0);
  24:	4501                	li	a0,0
  26:	00000097          	auipc	ra,0x0
  2a:	294080e7          	jalr	660(ra) # 2ba <exit>
    write(1 , "error" , 6);
  2e:	4619                	li	a2,6
  30:	00000597          	auipc	a1,0x0
  34:	7a858593          	addi	a1,a1,1960 # 7d8 <malloc+0xe8>
  38:	4505                	li	a0,1
  3a:	00000097          	auipc	ra,0x0
  3e:	2a0080e7          	jalr	672(ra) # 2da <write>
  42:	b7cd                	j	24 <main+0x24>
